...
async def help(update, context):
    await update.message.reply_text(
        ...
        "/weather - функция погоды (всё вводится в одно сообщение). (сначала обязательно вводится место, для которого вы хотите узнать погоду"
        ...
        "после этого вводится необязательная дата в формате 'date: ГГГГ-ММ-ДД', на которую вы хотите узнать прогноз погоды)")
